...
async def base_channel_photo_ai(message: types.Message):
    ...
    try:
        ...
        await _notify_admin("⚠️ AI poster tugmasini baza kanaldagi rasmga qo‘sha olmadi. Bot kanal postlarini tahrirlash huquqini tekshiring.")
...
async def base_channel_video_ai(message: types.Message):
    ...
    try:
        ...
        await _notify_admin("⚠️ AI video tugmasini baza kanaldagi videoga qo‘sha olmadi. Bot kanal postlarini tahrirlash huquqini tekshiring.")
